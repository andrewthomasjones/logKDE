...
![](http://www.r-pkg.org/badges/version-last-release/logKDE)[![Downloads
...
- all of the methods that available for density, applied to
  ...
  [`?bw.nrd`](https://rdrr.io/r/stats/bandwidth.html) regarding the
  options),
...
![](reference/figures/README-example1-2.png)
